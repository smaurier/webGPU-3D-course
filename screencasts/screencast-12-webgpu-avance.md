...
| 3:00-5:00 | Premiere passe : écrire le G-buffer avec MRT (Multiple Render Targets) | VS Code |
...
- Le G-buffer consomme beaucoup de mémoire : chaque pixel stocke plusieurs textures
...
- Référence : "Deferred Shading" sur learnopengl.com
