...
| 4:00-7:00 | Ecriture du compute shader : generation de rayons depuis la camera | VS Code + rendu WebGPU en direct |
...
- Le compute shader qui ecrit directement dans une texture de sortie
...
- Comparaison visuelle avant/apres BVH (compteur d'intersections testees)
