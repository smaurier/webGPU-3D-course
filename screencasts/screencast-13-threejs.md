# Screencast 13 — Three.js : du hello world a la scene interactive

## Objectifs
- Installer Three.js et comprendre son architecture (Scene, Camera, Renderer)
- Creer des geometries, materiaux et meshes de base
...
| 7:00-8:30 | Creer un mesh et l'ajouter a la scene | VS Code + navigateur |
...
- Three.js gere automatiquement les matrices, shaders et etats WebGL
