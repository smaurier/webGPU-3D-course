...
## Objectifs
- Maitriser la syntaxe GLSL : types, fonctions built-in, precision
...
| 7:00-8:30 | Charger une image et creer une texture WebGL | VS Code + navigateur |
...
- Les coordonnees UV vont de 0 a 1, independamment de la resolution de la texture
