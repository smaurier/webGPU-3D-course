...
- Maîtriser le produit scalaire (dot) et le produit vectoriel (cross)
- Comprendre les matrices 4x4 et la multiplication matricielle
- Visualiser les operations vectorielles de manière interactive
...
| 5:30-7:00 | Produit vectoriel : formule, normale à un plan | VS Code + canvas demo |
...
| 11:00-12:30 | Demo interactive : manipulation de vecteurs en temps réel | Navigateur |
| 12:30-13:00 | Récapitulatif et exercices | Slides |
...
- Livre de référence : "3D Math Primer for Graphics and Game Development"
