...
- Ecrire un shader pass personnalise
...
| 2:30-4:00 | Setup : EffectComposer, RenderPass comme premiere passe | VS Code |
| 4:00-6:00 | UnrealBloomPass : parametres (strength, radius, threshold) | VS Code + navigateur |
...
| 10:30-12:30 | ShaderPass personnalise : ecrire un effet vignette | VS Code |
...
- Chaque passe lit un framebuffer et ecrit dans un autre (ping-pong)
...
- Reference : "GPU Gems" chapitres sur Bloom et SSAO
