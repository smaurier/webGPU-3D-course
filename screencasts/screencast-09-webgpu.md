...
- Ecrire un premier shader en WGSL (WebGPU Shading Language)
- Creer un render pipeline et dessiner un triangle
...
| 4:00-5:30 | WGSL : syntaxe de base, differences avec GLSL | VS Code |
| 5:30-7:00 | Vertex shader WGSL : @vertex, @builtin(position) | VS Code |
| 7:00-8:00 | Fragment shader WGSL : @fragment, @location(0) | VS Code |
| 8:00-10:00 | Creer le render pipeline : vertex state, fragment state, topology | VS Code |
...
- Le pipeline est un objet immutable cree une seule fois
