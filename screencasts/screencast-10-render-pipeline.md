...
| 1:00-3:00 | Bind groups : le système de ressources de WebGPU | Slides + VS Code |
| 3:00-5:00 | Uniform buffers : créer, écrire, binder au shader | VS Code |
...
| 8:00-9:30 | Depth buffer : créer une depth texture, configurer le depth stencil state | VS Code |
...
- Un uniform buffer peut contenir plusieurs valeurs (matrices, paramètres de lumiere)
