...
## Objectifs
- Comprendre les modèles d'eclairage : Lambert, Phong, Blinn-Phong
- Decouvrir le Physically Based Rendering (PBR) et ses paramètres
- Implementer progressivement chaque modèle d'eclairage
- Comparer visuellement les résultats avec un editeur de materiaux
...
| 2:30-4:00 | Modèle Lambert : eclairage diffus pur (N dot L) | VS Code + demo canvas |
| 4:00-5:30 | Modèle Phong : ajout du reflet speculaire (R dot V) | VS Code + demo canvas |
| 5:30-7:00 | Modèle Blinn-Phong : optimisation avec le half vector (N dot H) | VS Code + demo canvas |
...
| 13:00-14:30 | Comparaison cote a cote des quatre modèles | Visualisation lighting-models.html |
| 14:30-15:00 | Récapitulatif | Slides |

## Points clés a montrer
- La progression naturelle de Lambert vers PBR
- Le dot product est au coeur de tous les modèles d'eclairage
- PBR utilise des propriétés physiques mesurables (metalness, roughness)
...
- Référence : "PBR Book" de Pharr, Jakob et Humphreys
