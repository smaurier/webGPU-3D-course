# Screencast 15 — Chargement de modèles glTF et animations

## Objectifs
- Charger des modèles 3D au format glTF/GLB avec Three.js
- Naviguer dans la hiérarchie d'un modèle charge (scene graph)
...
| 1:00-2:30 | GLTFLoader : charger un modèle .glb | VS Code + navigateur |
| 2:30-4:00 | Explorer le résultat : scene, nodes, meshes, materiaux | VS Code + console |
| 4:00-5:30 | Ajuster la taille et la position du modèle charge | VS Code + navigateur |
| 5:30-7:00 | Hiérarchie : parcourir le scene graph avec traverse() | VS Code + console |
...
| 12:00-14:00 | InstancedMesh : afficher 1000 copies d'un même modèle | VS Code + navigateur |
...
- glTF supporte les materiaux PBR, animations, et hiérarchie dans un seul fichier
- AnimationMixer fonctionne avec un delta time à chaque frame
