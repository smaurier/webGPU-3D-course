...
- Créer un cycle de marche procedural avec des sinusoides
...
| 1:30-4:30 | Setup WebXR : requestSession, référence spaces, render loop XR | Code + navigateur avec emulateur XR |
...
| 11:30-14:00 | Cinematique inverse : problème IK, approche analytique 2 joints | Demo 2D interactive |
...
| 19:30-20:30 | Intégration : personnage VR avec IK sur les mains trackees | Demo finale dans le casque |
...
- Overlay montrant les zones de résolution en foveated rendering (centre vs peripherie)
