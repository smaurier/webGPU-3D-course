...
Algorithme efficace qui calcule simultanement le parametre `t` et les coordonnees
...
- **Echantillonnage cosinus** : generer des directions dans un hemisphere pondere par le cosinus
- **Estimation de PI** : methode classique par points aleatoires dans un carre unitaire
