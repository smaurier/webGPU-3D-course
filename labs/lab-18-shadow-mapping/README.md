...
Pour générer une shadow map, on projette la scene depuis le point de vue de la lumiere.
...
Le "shadow acne" apparait quand la résolution de la shadow map est insuffisante.
...
et on moyenne les résultats pour obtenir des ombres douces.

### Cascaded Shadow Maps (CSM)

On divise le frustum de la camera en cascades. Chaque cascade a sa propre shadow map.
Le "practical split scheme" melange découpage logarithmique et lineaire.
