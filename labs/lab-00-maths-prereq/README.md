# Lab 00 — Prerequis mathematiques

## Objectif

Revoir les bases mathematiques indispensables avant de plonger dans la 3D temps reel :
...
- `smoothstep(edge0, edge1, x)` interpole de facon lisse entre 0 et 1 avec une courbe cubique hermitienne
...
Un vecteur `[x, y]` a une longueur (`sqrt(x^2 + y^2)`) et peut etre normalise (longueur ramenee a 1).
...
Si paralleles et de meme direction, il vaut le produit de leurs longueurs.
